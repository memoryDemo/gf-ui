<template>
   <div class="app-container">
      ...
      <el-row :gutter="10" class="mb8">
         <el-col :span="1.5">
            <el-button
               ...
               :disabled="multiple"
               @click="handleDelete"
               v-hasPermi="['system/operLog/delete']"
            >删除</el-button>
         </el-col>
         <el-col :span="1.5">
            <el-button
      ...
      <el-table ref="operlogRef" v-loading="loading" :data="operlogList" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
         ...
         <el-table-column label="操作日期" align="center" prop="createdAt" sortable="custom" :sort-orders="['descending', 'ascending']" width="180">
            <template #default="scope">
         ...
         <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
            <template #default="scope">
               <el-button
                  ...
                  v-hasPermi="['system/operLog/getOne']"
               >详细</el-button>
            </template>
         </el-table-column>
      </el-table>
      ...
      <el-dialog title="操作日志详细" v-model="open" width="700px" append-to-body>
         <el-form :model="form" label-width="100px">
            <el-row>
               ...
               <el-col :span="12">
                  <el-form-item label="操作时间：">{{ parseTime(form.createdAt) }}</el-form-item>
               </el-col>
               <el-col :span="24">
